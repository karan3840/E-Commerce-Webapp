...
<head>
    ...
    <title>E-Commerce website for single product</title>
</head>
<body>
  <div class="top-nav-bar">
      ...
      <i class="fas fa-times"id="close-btn" onclick="closemenu()"></i> 
        ...
        <span class="input-group-text"><i class="fa fa-search" aria-hidden="true">
        </i></span>
      </div>
      <div class="menu-bar">
        <ul>
                ...
                <div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="images/shirt1.jpg" class="d-block " >
                      </div>
                      <div class="carousel-item">
                        <img src="images/shirt2.jpg" class="d-block ">
                      </div>
                      <div class="carousel-item">
                        <img src="images/shirt4.jpg" class="d-block ">
                      </div>
...
<!--product discription--->
<section class="product-discription container">
    <h6>Product</h6>
    <p>
        A product description is the marketing copy that explains what
         ...
         and benefits of the product so they're compelled to buy.
         A product description is the marketing copy that explains what
         a product is and why it's worth purchasing. The purpose of a product 
         description is to supply customers with important information about the features
         and benefits of the product so they're compelled to buy.
...
<section class="footer">
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-md-3">
            <h1>Download</h1>
            <img src="images/playnew.png" alt="">
            </div>
    </div>
    <hr class="bg-color:white;">
    <small>Designed by Dhiraj and Karan &copy;2020</small>
